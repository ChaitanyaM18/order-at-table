...
function order_details(dish_name, price){
  alert('hi');
var last_valid_selection = null; //this is what restircts the user from choosing more than they are paying fpr
  var info={
    "item_description": dish_name,
    "price":price
  }
  add_to_cart(info)
};
